...
class TodoOverdueCompletionTests(unittest.TestCase):
    ...
    def test_complete_overdue_tasks_completes_periodic_and_legacy_with_meta_fallback(self):
        ...
        self.assertEqual(result['handled'], ['FIN-101', 'ID16', 'ID17'])
    ...
    def test_complete_overdue_tasks_dry_run_does_not_change_state(self):
        ...
        self.assertEqual(result['handled'], ['FIN-101', 'ID16', 'ID17'])
        self.assertEqual(len(result['simulated']), 3)
